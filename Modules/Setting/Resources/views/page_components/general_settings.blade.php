                ...
                <div class="single_system_wrap">
                    <div class="row">
                        ...
                        <div class="col-xl-6">
                            <div class="primary_input mb-25">
                                <label class="primary_input_label"
                                       for="preloader_status">{{__('setting.Preloader Status')}} </label>
                                <select class="primary_select mb-25" name="preloader_status"
                                        id="preloader_status">
                                    <option value="1"
                                            @if (Settings('preloader_status') == 1) selected @endif>Show
                                    </option>

                                    <option value="0"
                                            @if (Settings('preloader_status') == 0) selected @endif>Hide
                                    </option>
                                </select>
                            </div>
                        </div>
