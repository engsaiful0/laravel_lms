<li>
    ...
    <ul>
        ...
        @if(isModuleActive('Org') && permissionCheck('org.branch')  && permissionCheck('org.position'))
            <li>
                <a href="{{ route('org.branch') }}">{{__('org.Branch')}}</a>
            </li>

            <li>
                <a href="{{ route('org.position') }}">{{__('org.Position')}}</a>
            </li>
        @endif
